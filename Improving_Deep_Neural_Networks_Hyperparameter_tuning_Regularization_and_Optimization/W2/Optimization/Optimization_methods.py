...
def initialize_velocity(parameters):
    ...
    for l in range(1, L + 1):
        ...
        # v["db" + str(l)] =
        # YOUR CODE STARTS HERE
        v["dW" + str(l)] = np.zeros(list(parameters["W" + str(l)].shape))
        v["db" + str(l)] = np.zeros(list(parameters["b" + str(l)].shape))
        # YOUR CODE ENDS HERE
...
def initialize_adam(parameters) :
    ...
    # YOUR CODE STARTS HERE
        v["dW" + str(l)] = np.zeros(list(parameters["W" + str(l)].shape))
        v["db" + str(l)] = np.zeros(list(parameters["b" + str(l)].shape))
        s["dW" + str(l)] = np.zeros(list(parameters["W" + str(l)].shape))
        s["db" + str(l)] = np.zeros(list(parameters["b" + str(l)].shape))
